...
public class User {
    ...
    public void userDialog() {
     ...
     pane.showMessageDialog(frame, "Eggs are not supposed to be User.");
     }
...
System.out.println(alias + " " + password);
 ...
 //       String q = "Select count(*) from User where User.alias = 'ann' and User.password = 'botany'";
        ResultSet rs = query.executeQuery(connection);
      
        System.out.println("inside login after query");
...
System.out.println("User in try" + count);
            rs.first();
